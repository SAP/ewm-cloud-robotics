*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZEWM_V_ERR_QUEUE
*   generation date: 05.03.2020 at 10:43:17
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZEWM_V_ERR_QUEUE    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZEWM_V_ERR_QUEUE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZEWM_V_ERR_QUEUE_EXTRACT
TOTAL = ZEWM_V_ERR_QUEUE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZEWM_V_ERR_QUEUE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZEWM_V_ERR_QUEUE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZEWM_V_ERR_QUEUE_EXTRACT
TOTAL = ZEWM_V_ERR_QUEUE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZEWM_V_ERR_QUEUE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZEWM_V_ERR_QUEUE'
...
TOTAL = ZEWM_V_ERR_QUEUE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZEWM_V_ERR_QUEUE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZEWM_V_ERR_QUEUE-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZEWM_V_ERR_QUEUE'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZEWM_V_ERR_QUEUE-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZEWM_V_ERR_QUEUE_EXTRACT
TOTAL = ZEWM_V_ERR_QUEUE_TOTAL
