...
class RobotEWMConfig:
    ...
    states = [
        'robotError', 'movingToStaging', state_charging,
    ...
    transitions: List[Dict] = [
        ...
        {'trigger': t_charge_battery,
         'source': [*idle_states, 'movingToStaging', 'robotError'],
         'dest': state_charging,
         'conditions': '_battery_empty'},
        {'trigger': t_charge_battery,
         'source': [*idle_states, 'movingToStaging', 'robotError'],
         'dest': state_charging,
         'unless': '_battery_empty'},
        {'trigger': t_mission_succeeded,
         'source': state_charging,
         'dest': 'idle'},
        {'trigger': t_mission_failed,
         'source': state_charging,
         'dest': '=',
        ...
        {'trigger': t_process_warehouseorder,
         'source': [
             'idle', state_charging, 'atStaging', 'movingToStaging',
