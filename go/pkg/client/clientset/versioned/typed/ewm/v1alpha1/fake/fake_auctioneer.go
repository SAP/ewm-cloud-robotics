...
func (c *FakeAuctioneers) Get(name string, options v1.GetOptions) (result *v1alpha1.Auctioneer, err error) {
	obj, err := c.Fake.
...
func (c *FakeAuctioneers) List(opts v1.ListOptions) (result *v1alpha1.AuctioneerList, err error) {
	obj, err := c.Fake.
...
func (c *FakeAuctioneers) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeAuctioneers) Create(auctioneer *v1alpha1.Auctioneer) (result *v1alpha1.Auctioneer, err error) {
	obj, err := c.Fake.
...
func (c *FakeAuctioneers) Update(auctioneer *v1alpha1.Auctioneer) (result *v1alpha1.Auctioneer, err error) {
	obj, err := c.Fake.
...
func (c *FakeAuctioneers) UpdateStatus(auctioneer *v1alpha1.Auctioneer) (*v1alpha1.Auctioneer, error) {
	obj, err := c.Fake.
...
func (c *FakeAuctioneers) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeAuctioneers) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(auctioneersResource, c.ns, listOptions)
...
func (c *FakeAuctioneers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Auctioneer, err error) {
	obj, err := c.Fake.
