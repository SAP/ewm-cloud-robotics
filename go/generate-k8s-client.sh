...
mkdir -p "$DIR/../tmp/.gopath/src/github.com/SAP/ewm-cloud-robotics/go/pkg"
mkdir -p "$DIR/../tmp/.gopath/src/k8s.io"
mkdir -p "$DIR/../tmp/.gopath/bin"
# Copy preserving file attributes
cp -R -p "$DIR/pkg/apis" "$DIR/../tmp/.gopath/src/github.com/SAP/ewm-cloud-robotics/go/pkg"
cd "$DIR/../tmp/.gopath/src/github.com/SAP/ewm-cloud-robotics"
TEMP_REPO=$(pwd)
...
cp -Rf -p "$DIR/../tmp/.gopath/src/github.com/SAP/ewm-cloud-robotics/go/pkg/apis" "$DIR/pkg"
cp -Rf -p "$DIR/../tmp/.gopath/src/github.com/SAP/ewm-cloud-robotics/go/pkg/client" "$DIR/pkg"
