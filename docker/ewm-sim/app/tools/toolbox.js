...
module.exports = {
    createEntity(entitySet, entity) {
        let uri = "https://localhost:8000/odata/SAP/ZEWM_ROBCO_SRV/" + entitySet
        let options = {
            method: 'POST',
            body: entity
        }
    ...
    waitForService() {
        let uri = "https://localhost:8000/odata/SAP/ZEWM_ROBCO_SRV/$metadata"
        let options = {
            method: 'GET'
        }
        return this.makeRequest(uri, options)
    ...
    getEntity(entitySet, oUrlParams) {
        ...
        let uri = "https://localhost:8000/odata/SAP/ZEWM_ROBCO_SRV/" + entitySet + sUrlParams
        let options = {
            method: 'GET',
            body: {}
        }
    ...
    oDataPostFunction(functionName, oUrlParams) {
        ...
        let uri = "https://localhost:8000/odata/SAP/ZEWM_ROBCO_SRV/" + functionName + sUrlParams
        let options = {
            method: 'POST',
            body: {}
        }
